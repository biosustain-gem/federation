...
const AddKeyPlugin = builder => {
    ...
    builder.hook("GraphQLObjectType", (type, build, context) => {
        ...
        const astNode = Object.assign({}, AST_1.ObjectTypeDefinition({ name: type.name }), type.astNode);
    ...
    builder.hook("GraphQLObjectType:interfaces", (interfaces, build, context) => {
         ...
         * output it.
         */
        const astNode = Object.assign({}, AST_1.ObjectTypeDefinition(spec), Self.astNode);
